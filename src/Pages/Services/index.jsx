    ...
    <SectionContainer>
      <Styled.Container>
        ...
        <p>
          ...
          tecnologias e metodologias para garantir que sua solução esteja sempre
          atualizada e em conformidade com as melhores práticas da indústria.
        </p>
        <h1>Suporte Técnico</h1>
        <p>
          Oferecemos suporte técnico para ajudar a manter sua infraestrutura em
          funcionamento. Desde a configuração inicial até o suporte contínuo,
          nossa equipe de suporte técnico está sempre pronta para ajudar.
        </p>
        <h1>Consultoria em TI</h1>
        <p>
          Se você precisa de ajuda para tomar decisões estratégicas em relação à
          tecnologia da informação, podemos ajudar. Oferecemos serviços de
