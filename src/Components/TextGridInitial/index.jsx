...
export const TextGridInitial = () => {
  ...
  <>
    ...
    <DefaultContainer>
      ...
      <BoxTextContent>
        Através de pesquisas realizadas em diversas plataformas de ensino, foi possível verificar que 99% possuem projetos-modelo disponíveis que induz o aluno a copiar e colar projetos prontos, sem levar em conta assimilaridade do conteúdo.
      </BoxTextContent>
